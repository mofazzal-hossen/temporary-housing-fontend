...
const Footer = () => {
  return (
    <footer className="bg-slate-900 border-t border-slate-700 text-white pt-24 pb-8 relative overflow-hidden mt-10 w-full">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-16">
          ...
          <div className="lg:col-span-4 flex flex-col pr-0 lg:pr-8">
            {/* Text Logo: temporary-housing */}
            <Link href="/" className="inline-block mb-6 group">
              <div className="flex items-center gap-2.5">
                <img
                  src="/logo.png"
                  alt="temporary-housing logo"
            ...
            <div className="mb-8 flex items-center gap-5">
              ...
              <Button isIconOnly size="md" radius="md">
                <SendIcon />
              </Button>
            </div>
        ...
        <div className="pt-8 border-t border-slate-700 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-gray-400">
            © {new Date().getFullYear()} temporary-housing. All rights reserved.
          </p>
